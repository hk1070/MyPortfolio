...
$(function () {
  ...
  $('.insidek')
    .append(
      '<img src="images/sban1_' + rdn + '.gif" alt="인사이드카카오이미지">'
    )
    .css({
  ...
  //////////////////////////////////////////////////////////////////////
  let wtxt = [
    '무엇이든 본질만 남기고<br>처음부터 다시 생각해 봅니다.<br><br>Back to Basic ',
  ...
  $('.wstxt').empty().append(wtxt[rdn2]).parent().css({
...
let txt2 = [
  '항상 재밌게 일하고자 하는 <br>동료를 기다리고 있습니다.',
